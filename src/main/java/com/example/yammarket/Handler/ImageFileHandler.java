//package com.example.yammarket.Handler;
//
...
//
//    public ImageFileHandler(ImageFileService imageFileService) {
//        this.imageFileService = imageFileService;
//    }
//
//    public List<ImageFiles> parseFileInfo(
//            List<MultipartFile> multipartFiles
//    )throws Exception {
//        // 반환할 파일 리스트
//        List<ImageFiles> fileList = new ArrayList<>();
//
//        // 전달되어 온 파일이 존재할 경우
...
//                        .build();
//
//                // 파일 DTO 이용하여 imageFile 엔티티 생성
//                ImageFiles imageFile = new ImageFiles(
//                        imageFileDto.getImageName(),
//                        imageFileDto.getImagePath(),
//                        imageFileDto.getImageSize()
//                );
//
//                // 생성 후 리스트에 추가
